    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('delete-vehiculo',$doc->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('delete')
                    <div class="text-center">
                        <h4 class="mb-1 text-danger">¿Desea eliminar este vehiculo?</h4>
                        <p class="card-text m-auto w-75">
                           {{$doc->marca}} - {{$doc->placa}} - {{$doc->unidad}}
                        </p>
                    </div>
         </div>
